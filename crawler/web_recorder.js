...
(async () => {
  ...
  let url ='file:' + path.resolve(__dirname, 'scroll/miaov_demo.html')
  url = 'file:' + '/Users/lichong/Sources/WebGLSamples.github.io/aquarium/aquarium.html'
  url = 'https://webglsamples.org/aquarium/aquarium.html'
  url = 'http://arodic.github.io/p/jellyfish/'
  console.log(url)
  await page.goto(url, {timeout: 60000})
  const recorderScript = path.resolve(__dirname, '../util/canvas_recorder.js')
  await page.evaluate(fs.readFileSync(recorderScript, 'utf8'))
